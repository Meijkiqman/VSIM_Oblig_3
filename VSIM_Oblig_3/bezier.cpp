...
//oppg7
Bezier::Bezier(std::vector<QVector3D> controlPoints, Shader* shader) : VisualObject(shader)
{
...
void Bezier::init(GLint matrixUniform)
{
...
QVector3D Bezier::EvaluateBezier(float t)
{
