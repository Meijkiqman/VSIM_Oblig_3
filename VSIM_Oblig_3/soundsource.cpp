    ...
    mVelocity(0.0f, 0.0f, 0.0f)
{
    ...
    ALfloat temp[3] = {mPosition.mX, mPosition.mY, mPosition.mZ};
    alSourcefv(mSource, AL_POSITION, temp);
    ALfloat temp2[3] = {mVelocity.mX, mVelocity.mY, mVelocity.mZ};
...
void SoundSource::setPosition(Vector3D newPos)
{
    mPosition = newPos;
    ALfloat temp[3] = {mPosition.mX, mPosition.mY, mPosition.mZ};
    alSourcefv(mSource, AL_POSITION, temp);
}
void SoundSource::setVelocity(Vector3D newVel)
{
    mVelocity = newVel;
    ALfloat temp[3] = {mVelocity.mX, mVelocity.mY, mVelocity.mZ};
